...
function Proyectos() {
  ...
  return (
    <section className="area h-px-screen-laptop 2xl:h-px-screen-pc bg-redd-500 snap-center relative flex flex-col justify-center items-center text-white py-20 lg:py-0">
      <i
