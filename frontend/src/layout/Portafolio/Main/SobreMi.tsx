...
function SobreMi() {
  ...
  return (
    <section className="area h-[1050px] bg-redd-500 flex flex-col justify-center items-center snap-center text-white">

        <section className="w-[80%] h-[25%] flex flex-col justify-center items-center space-y-4 bg-bluee-500">
        ...
        <section className="w-full h-[50%] flex justify-between items-center bg-bluee-500">

          <section className="w-[30%] h-[220px] flex flex-col justify-start items-center space-y-5 bg-limee-500">   
          ...
          <picture className="w-[40%] h-auto relative flex justify-center items-center z-10 bg-limee-500 ">
